...
public class InterfazVideotienda extends JFrame
{
    ...
    public InterfazVideotienda( )
    {
        ...
        {
            JOptionPane.showMessageDialog( this, "No se pudo cargar la informacion de las peliculas del archivo " + archivo, "Videotienda UniAndes", JOptionPane.INFORMATION_MESSAGE );
        }
    ...
    public void cambiarTarifa( int tarifa )
    {
        try
        {
            ...
            JOptionPane.showMessageDialog( this, "La tarifa fue actualizada con exito", "Cambio de Tarifa", JOptionPane.INFORMATION_MESSAGE );
        }
        catch( Exception e )
        {
    ...
    public void mostrarPelicula( String titulo )
    {
        ...
        if( p == null )
            JOptionPane.showMessageDialog( this, "La pelecula no existe", "Ver Informacion Pelceula", JOptionPane.ERROR_MESSAGE );
    ...
    public void mostrarCliente( String cedula )
    {
        ...
        if( c == null )
        {
            JOptionPane.showMessageDialog( this, "El cliente no est� registrado", "Ver Informacion Cliente", JOptionPane.ERROR_MESSAGE );
            return;
        }
    ...
    public void afiliarCliente( String nombre, String cedula, String direccion, int saldo )
    {
        ...
        {
            JOptionPane.showMessageDialog( this, e.getMessage( ), "Afiliacion de Cliente", JOptionPane.ERROR_MESSAGE );
            return;
        }

        panelClientes.actualizarClientes( videotienda.darClientes( ) );
    }
    ...
    {
        return videotienda.darClientes();
    }
    ...
    public void alquilarPelicula( )
    {
        ...
        if( pelicula == null )
        {
            JOptionPane.showMessageDialog( this, "Debe seleccionar una pelicula", "Alquilar Pelicula", JOptionPane.ERROR_MESSAGE );
            return;
        }
        String cliente = panelClientes.darClienteSeleccionado( );
        if( cliente == null )
        {
            JOptionPane.showMessageDialog( this, "Debe seleccionar un cliente", "Alquilar Pelicula", JOptionPane.ERROR_MESSAGE );
            return;
        }
        try
        {
            int copia = videotienda.alquilarPelicula( pelicula, cliente );
            JOptionPane.showMessageDialog( this, "Se alquilo la copia " + copia + " de la pelicula \"" + pelicula + "\"", "Alquilar Pel�cula", JOptionPane.INFORMATION_MESSAGE );
        }
        catch( Exception e )
        {
            JOptionPane.showMessageDialog( this, e.getMessage( ), "Alquilar Pelicula", JOptionPane.ERROR_MESSAGE );
        }
    }
