...
public class DialogoRegistroCliente extends JDialog
{
    ...
    public DialogoRegistroCliente( InterfazVideotienda ventana )
    {
        ...
        pack( );
        setTitle( "Afiliacion de Cliente" );
    }
    ...
    public void aceptar( )
    {
        ...
        if (!cedula.matches("\\d{10}")) {
            JOptionPane.showMessageDialog(this, "La cedula debe contener exactamente 10 numeros", "Afiliación de Cliente", JOptionPane.ERROR_MESSAGE);
            return;
        }
